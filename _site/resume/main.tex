...
\begin{document}
    ...
    \begin{minipage}{0.85\textwidth}
        \begin{center}
            {\bf \LARGE Tejas Salian} 
            \\ [4mm] \hfill                 % Phone number
            \phoneChar +91 99163 32393 
            \hfill                          % Email address
            \texttt{tejasps28@gmail.com} 
            \hfill                          % Address
            \homeChar Bengaluru, Karnataka, IN 
            \hfill { } \\ [1mm] \hfill      % Blog
            \webChar \href{https://tejasps28.github.io/}{
                tejasps28.github.io} 
            \hfill                          % Linkedin
            \linkedinChar \href{
                https://www.linkedin.com/in/tejas-salian/}{
                tejas-salian}
            \hfill                          % GitHub
            \githubChar \href{https://github.com/tejasps28}{
                tejasps28}
            \hfill { } \\
        \end{center}
    \end{minipage}
    ...
    \begin{itemize}
        \setlength{\itemsep}{0mm}
        \item Thesis: \href{https://github.com/tejasps28/IIITH-MS-Thesis}{Foundation Models for Visual Place Recognition}
        \item RRC Summer School 2022 - Multi-View Geometry (\href{https://github.com/tejasps28/RRC22-Summer-School-MVG4}{GitHub})
